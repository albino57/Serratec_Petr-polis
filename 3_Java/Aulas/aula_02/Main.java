public class Main {
    ...
    public static void main(String[] args) {
        ...
        // controle de codigo
        // se senao
        String messagemParaImprimir;
        if (somaTres > 10) {
            messagemParaImprimir = "A variavel soma 3 é maior que 10";
            somaTres = 0;
        } else {
            messagemParaImprimir = "A variavel soma 3 é menor do que 10";
        }
        System.out.println(messagemParaImprimir);

        String messagem = somaTres > 10 ? "A variavel soma 3 é maior que 10" : "A variavel soma 3 é menor do que 10";
        System.out.println(messagem);

        int salarioDesejado = 6000;


        if (salarioDesejado < 5000){
            System.out.println("Sem imposto de renda");
        } else if (salarioDesejado < 6000) {
            System.out.println("O imposto é de 5%");
        } else if (salarioDesejado < 7000){
            System.out.println("O imposto é de 7.5%");
        }

        // escolha caso
        switch (salarioDesejado) {
            case 5000:
                System.out.println("Sem imposto de renda");
                break;
            case 6000:
        ...
        // switch (salarioDesejado) {
        //  case typeOf Integer n when n < 5000:
        //      System.out.println("Sem imposto de renda");
        //      break;
        //  case typeOf String n when
        //
        // }
        ...
        // para
        for(int contadorTres = 0; contadorTres < 20; contadorTres = contadorTres * 2) {
